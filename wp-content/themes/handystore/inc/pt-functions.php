...
if (!function_exists('pt_site_wrapper_start')) {
	function pt_site_wrapper_start() {
		if (get_option('site_layout')=='boxed') { ?>
...
function optionscheck_display_sidebar() { ?>
	<div id="options-sidebar-holder" class="metabox-holder">
	  <div id="options-sidebar">
	    ...
	    <div class="section">
				<p><?php echo wp_kses( __('Please, create ticket at <a href="http://support.themes.zone" target="_blank">http://support.themes.zone</a> to get help with the theme.', 'plumtree'), $allowed_html=array('a' => array( 'href'=>array(),'target'=>array() )) ); ?></p>
			...
			<div class="support-links">
				...
				<span>&nbsp;|&nbsp;</span>
				<a href="http://support.themes.zone" target="_blank" title="<?php esc_html_e('Create Support Ticket', 'plumtree'); ?>"><i class="custom-icon-support"></i><?php esc_html_e('Support', 'plumtree'); ?></a>
			</div>
	  </div>
	</div>
<?php }
