...
function pt_layout_metabox_contents($post) {
  ...
  $current_layout = pt_get_post_layout( $post->ID ); ?>
	<div class="post-layout">
		...
		<input type="radio" name="dash_post_layout" id="post-layout-default" value="default" <?php checked( $current_layout, "default" )?> />
		<label for="post_layout_default"><?php esc_html_e( 'Default Set in Handy Store Theme Options','plumtree') ?></label><br /><br />
			...
			<input type="radio" id="post-layout-<?php echo esc_attr( $key['value'] ); ?>" class="of-radio-img-radio" value="<?php echo esc_attr( $key['value'] ); ?>" name="dash_post_layout" <?php checked( $current_layout, $key['value'] ); ?> />
