	...
	?>
		...
		<p>
            ...
            <select class="widefat" id="<?php echo $this->get_field_id('post-type'); ?>" name="<?php echo $this->get_field_name('post-type'); ?>">
          		<option value="post" <?php selected( $instance["post-type"], "post" ); ?>><?php _e( 'Posts', 'plumtree' ) ?></option>
          		<option value="product" <?php selected( $instance["post-type"], "product" ); ?>><?php _e( 'Products', 'plumtree' ) ?></option>
            </select>
        </p>
        <p>
        	...
        	<select class="widefat" id="<?php echo $this->get_field_id("sort-by"); ?>" name="<?php echo $this->get_field_name("sort-by"); ?>">
          		<option value="date" <?php selected( $instance["sort-by"], "date" ); ?>><?php _e( 'Date', 'plumtree' ) ?></option>
          		<option value="title" <?php selected( $instance["sort-by"], "title" ); ?>><?php _e( 'Title', 'plumtree' ) ?></option>
          		<option value="comment_count" <?php selected( $instance["sort-by"], "comment_count" ); ?>><?php _e( 'Number of comments', 'plumtree' ) ?></option>
				<option value="author" <?php selected( $instance["sort-by"], "author" ); ?>><?php _e( 'Author', 'plumtree' ) ?></option>
           		<option value="rand" <?php selected( $instance["sort-by"], "rand" ); ?>><?php _e( 'Random', 'plumtree' ) ?></option>
        	</select>
        </p>
        <p>
			...
			<li class="recent-post-item">
				...
				<div class="content-wrapper">
					...
					<div class="recent-posts-entry-meta">
						...
						<?php if ($show_date && $post_type != 'product') :?>
						...
						<?php if ($show_cats && $post_type != 'product') :
					...
					<?php if ($show_excerpt && $post_type != 'product') : ?>
